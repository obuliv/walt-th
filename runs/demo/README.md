...
`--ignore-sql-good`, ollama-only severity dataset, `C=10` — see
`docs/experiments.md`), so reviewers can run evaluation without repeating the
...
The full C-sweep run log behind the `C=10` choice isn't included here (see
